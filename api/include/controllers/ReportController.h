...
public:
    METHOD_LIST_BEGIN
        ADD_METHOD_TO(ReportController::balanceSheet, "/api/reports/balance-sheet", drogon::Get, "JwtAuth");
        ADD_METHOD_TO(ReportController::incomeStatement, "/api/reports/income-statement", drogon::Get, "JwtAuth");
    METHOD_LIST_END
